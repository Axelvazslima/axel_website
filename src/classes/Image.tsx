...
export const SvgIcons = [
    ...
    new Image("svg-icons/github-icon-name.svg", ["contact"], "GitHub Name Logo", "The world's leading platform for version control and collaboration.", "https://github.com/Axelvazslima"),
    ...
    new Image("svg-icons/gihub-icon-white.svg", ["contact"], "GitHub Icon", "A variation of the GitHub logo for different design preferences.", "https://github.com/Axelvazslima"),
